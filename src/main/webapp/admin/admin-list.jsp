                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a href="coupon-code-type.jsp">Loại mã giảm giá</a></li>
                                <li><a href="coupon-code.jsp">Mã giảm giá</a></li>
                                <li><a href="ratingstype.jsp">Loại đánh giá</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a href="shipments.jsp">Vận chuyển</a></li>
                                <li><a href="return-request.jsp">Bảo hành</a></li>
                                <li><a href="review-reports.jsp">Đánh giá sản phẩm</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                <li><a href="users.jsp" >Khách hàng</a></li>
                                <li><a href="admin-list.jsp" class="active">Danh sách admin</a></li>
				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-auto text-right">
							<a href="add-admin.jsp" class="btn btn-primary add-button ml-3">
