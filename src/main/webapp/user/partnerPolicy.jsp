    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-center">
                <div class="header-nav" role="navigation" aria-label="Main navigation">
                  <ul class="menu">
                    ...
                    <li class="menu-item">
                      <a href="products.jsp"><span class="nav-link-text">Sản phẩm</span></a>
                      <div class="container">
                        <ul class="sub-menu">
                          <li class="menu-item">
                    ...
                    <li class="menu-item">
                      <a href="contact.jsp"><span class="nav-link-text">Liên hệ</span></a>
                    </li>
                  </ul>
                </div>
              </div>
            <div class="header-right">
                ...
                <div class="action">
                    <div class="cart" onclick="location.href='cart.jsp'">
